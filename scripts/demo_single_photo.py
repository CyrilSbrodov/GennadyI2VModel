...
def make_mock_scene() -> SceneGraph:
    person = PersonNode(
        person_id="p1",
        track_id="t1",
...
def main() -> None:
    ...
    parser.add_argument("--outdir", default="output/demo_single_photo", help="Папка вывода")
    parser.add_argument(
        "--scene-mode",
        default="mock",
        choices=["mock", "box"],
        help="Как собирать scene graph: mock или один большой bbox",
    )
