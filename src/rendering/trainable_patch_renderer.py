...
def output_from_prediction(
    ...
    exec_trace = {
        ...
        "conditioning_summary": conditioning_summary,
        "region_route_decision": diagnostics.get("region_route_decision", {}),
        "routing_region_id": diagnostics.get("routing_region_id", request.region.region_id),
        "canonical_region_id": diagnostics.get("canonical_region_id", request.region.region_id),
        "render_mode": diagnostics.get("render_mode", "unknown"),
        "material_provenance": diagnostics.get("material_provenance", "unknown"),
        "source_provenance": diagnostics.get("source_provenance", "unknown"),
